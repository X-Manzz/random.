...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; Android 10; RMX1821) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]')]
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93mSelect \033[91m:\033[1;96m ")
	if unikers =="":
...
#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93mSelect \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
